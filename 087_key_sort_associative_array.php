...
<head>
<meta charset="UTF-8">
<title>連想配列を添え字で並べたい</title>
<link href="../../css/style.css" rel="stylesheet">
</head>
<body>
<div>
<?php
echo '連想配列えおしえ時の数値比較で並び替える（昇順）';
...
echo '連想配列を添え字の文字列比較で並び替える（昇順）';
$data21 = array('bb7' => 1, 'aa' =>2, 'dd' => 3, 'cc' => 4);
echo '<table>';
echo '<tr><th>元の配列</th><th>ソート後</th></tr>';
echo '<tr><td><pre>';
print_r($data21);
...
echo '連想配列を添え字の文字列比較で並び替える（降順）';
$data22 = array('bb' => 1, 'aa' => 2, 'dd' => 3, 'cc' => 4);
echo '<table>';
echo '<tr><th>元の配列<M/th><th>ソート後</th></tr>';
echo '<tr><td><pre>';

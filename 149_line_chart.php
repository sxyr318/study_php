<?php
/ 別のファイルのユーザー定義関数「makeChartParts()」を読み込む
...
$options = array(
	...
	'titleTextStyle' => arry('fontSize' => 16), // タイトルのスタイル
	...
	'vAxes' => array(0 => array('title' => '平均気温(℃)', // 縦軸左側
			...
			1 => array('title' => '平均湿度(%)', // 縦軸右側
				'minValue' => 40, 'maxValur' => 80)),
	'width' => 550, 'height' => 340, // 幅、高さ
	'charsetArea' => array('width' => 460, 'height' => 240), // グラフエリア
...
<script src="https://www.google.com/jsapi"></scropt>
<script>
<?php
// グラフ描画関数を表示する
echo $chart, $table;
